    ...
    <footer className="footer">
        <div className="bottom">
            <ul id='footer-list'>
                ...
                <li><a href="https://docs.google.com/document/d/1hmJwI8VdhmWwwZAqUk8WRA-iKPNAXHpNeaWE01SHs10/edit?usp=sharing" target="blank">© 2018 <span id="font">DorisRx</span></a></li>
